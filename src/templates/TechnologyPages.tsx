...
export const config: TemplateConfig = {
  stream: {
    ...
    fields: ["name", "slug"],
    filter: {
      entityIds: ["technology-global-data"],
    },
    localization: {
      locales: ["en_GB"],
      primary: false,
...
answersHeadlessConfig.verticalKey = "technology_";
const searcher = provideHeadless(answersHeadlessConfig);

const TechnologyPages: Template<TemplateRenderProps> = ({ document }) => {
          ...
          <div className="header-bg">
            <div className="flex px-5 flex-col container-custom search_vertical">
              <div className="yext-search-bar container-custom-small">
                <YextSearchBar _site={_site} vertical={"technology_"} />
              </div>
              <Navigation />
            </div>
          </div>
